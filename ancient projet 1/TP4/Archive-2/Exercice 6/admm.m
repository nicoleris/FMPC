...
%% run admm
    ...
    for k=1:MAX_ITER
       ...
       %%                                                                %%
       %%****************************************************************%%
       invMat = inv([QQ AA'; AA zeros(size(AA,1),size(AA,1))]);
       z = invMat(1:size(AA,2),:)*[rho*(bar_z-mu);b];
       ...
       %%                                                                %%
       %%****************************************************************%%
       bar_z = min(max(z+mu,[repmat(xmin,[n*(N+1),1]);repmat(umin,[m*N,1])]),[repmat(xmax,[n*(N+1),1]);repmat(umax,[m*N,1])]);
