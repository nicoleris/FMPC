...
% figures to this Matlab file. We observed that raising the Q results in a
% smaller terminal set. This comes from the fact that a higher Q will raise
% the states cost in the LQR optimisation Problem. A higher state cost will
% result in a more agressive controller (higher gain K). Having a higher K
